  ...
  return (
    <Main>
      <div className="w-full h-full bg-white flex flex-col p-[8px] gap-[16px]">
        ...
        <div className="flex gap-[4px] w-full items-center justify-between ">
        ...
        <table>
          <thead>
            <tr className="bg-[#F2F4F8]">
              <th className="p-[8px] text-left">No</th>
              <th className="p-[8px] text-left">Full Name</th>
              <th className="p-[8px] text-left">Employee Number</th>
              <th className="p-[8px] text-left">Email</th>
              <th className="p-[8px] text-left">Role</th>
              <th className="p-[8px] text-left">Created At</th>
              <th className="p-[8px] text-left">Updated At</th>
              <th className="p-[8px] text-left">Action</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="p-[8px]">1</td>
              <td className="p-[8px]">Ade Badani</td>
              <td className="p-[8px]">123456</td>
              <td className="p-[8px]">ade@mail.com</td>
              <td className="p-[8px]">Admin</td>
              <td className="p-[8px]">1-1-2025</td>
              <td className="p-[8px]">2-2-2025</td>
              <td className="flex h-full p-[8px] gap-[4px] items-center">
                <button onClick={handleEditClick} className="text-white bg-blue-500 hover:bg-blue-400 p-[4px] cursor-pointer flex items-center h-full">
                  <FaEye />
                </button>
      ...
      {isAddShow && <FormAdduser onClick={handleAddClick} />}
      {isEditShow && <FormEditUser onClick={handleEditClick} />}
    </Main>
  );
};
